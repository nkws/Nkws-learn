...
function buildP1WbFeel1() {
  return shuffle([
    ...
    { q: "Are sad feelings okay to have?", a: "Yes, all feelings are okay", choices: ["Yes, all feelings are okay", "No, only happy is okay", "Only if something really bad happened"], explain: "Every feeling, even a sad one, is okay to have. You do not need a big reason to feel sad. What matters is choosing a kind and safe thing to do with that feeling." },
...
function buildP1WbThink1() {
  return shuffle([
    ...
    { q: "It is okay to ask questions when something seems strange.", a: "True", choices: ["True", "False", "Only if the teacher says so"], explain: "Questions help us learn and stay safe. You do not need permission to ask. Whenever something seems strange or unclear, it is always okay to ask about it." },
