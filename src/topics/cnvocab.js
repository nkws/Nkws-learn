...
function buildCnv2() {
  return shuffle([
    ...
    { q: "每天喝了帮助骨头长大的白色饮料叫什么？", a: "牛奶", choices: ["水", "牛奶", "果汁"], explain: "这种白色饮料含有钙质，帮助骨头长强，就是牛奶（niú nǎi）。水没有味道，果汁有颜色，所以答案是牛奶。" },
    { q: "圆圆的，有硬壳，剥开来吃的食物是什么？", a: "鸡蛋", choices: ["鸡蛋", "牛奶", "面包"], explain: "鸡蛋（jī dàn）外面有硬壳，圆圆的，煮熟剥开来吃。牛奶是饮料，面包是烤出来的，所以答案是鸡蛋。" },
