...
function buildP4sMg2() {
  return shuffle([
    ...
    { q: "Like poles?", a: "Repel each other", choices: ["Repel each other", "Attract each other", "Have no effect"], explain: "Like poles are the same, such as North and North or South and South. The rule is that like poles repel, pushing each other away." },
    { q: "Unlike poles?", a: "Attract each other", choices: ["Attract each other", "Repel each other", "Cancel each other out"], explain: "Unlike poles are different, such as North and South. The rule is that unlike poles attract, pulling each other together." },
