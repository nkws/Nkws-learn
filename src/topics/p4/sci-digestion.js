...
function buildP4sDg1() {
  return shuffle([
    ...
    { q: "Food is travelling through the oesophagus. Which process is happening there?", a: "Transport only — food is being pushed down, not digested", choices: ["Transport only — food is being pushed down, not digested", "Chemical digestion by digestive juices", "Nutrients are being absorbed into the blood"], explain: "The oesophagus is a transport tube, not a digesting organ. Its muscles squeeze to push food down to the stomach, but no breaking-down or absorbing takes place." },
    ...
    { q: "Digested food has arrived in the large intestine. Which statement best describes what happens there?", a: "Water is absorbed from the waste — no further digestion occurs", choices: ["Water is absorbed from the waste — no further digestion occurs", "Most nutrients are absorbed here from digested food", "Strong acid breaks down remaining food particles"], explain: "By the large intestine, digestion is complete. Its only job is to soak up water from the leftover waste before it leaves the body." },
