...
function buildP4sHt1() {
  return shuffle([
    { q: "In which direction does heat always travel between two objects?", a: "From the hotter object to the cooler one", choices: ["From the hotter object to the cooler one", "From the cooler object to the hotter one", "In any direction randomly"], explain: "Heat always moves from hotter to colder, never the other way. It keeps flowing until both objects reach the same temperature." },
    ...
    { q: "A student records the temperature of water as '37 __'. Which unit correctly completes the reading?", a: "°C (degrees Celsius)", choices: ["°C (degrees Celsius)", "g (grams)", "mL (millilitres)"], explain: "Temperature is recorded in degrees Celsius (°C). Grams measure mass and millilitres measure volume, so they cannot be used for a temperature reading." },
...
function buildP4sHt3() {
  return shuffle([
    { q: "What happens to the size of most materials when they are heated?", a: "They expand and take up more space", choices: ["They expand and take up more space", "They contract and take up less space", "Their size stays exactly the same"], explain: "Heating makes the tiny particles move faster and spread apart, so the material takes up more space. This is called expansion." },
    { q: "What happens to the size of most materials when they are cooled?", a: "They contract and take up less space", choices: ["They contract and take up less space", "They expand and take up more space", "Their size stays exactly the same"], explain: "Cooling makes the tiny particles slow down and move closer together, so the material shrinks and takes up less space. This is called contraction." },
