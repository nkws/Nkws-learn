...
function buildP2WbMoney1() {
  return shuffle([
    ...
    { q: "A piggy bank is for:", a: "Saving money", choices: ["Saving money", "Eating", "Sleeping"], explain: "A piggy bank is a safe place to keep money you are saving, so it grows little by little for something later." },
...
function buildP2WbEco1() {
  return shuffle([
    { q: "Where does most of Singapore's rubbish go?", a: "It is burned in factories, then ash goes to Pulau Semakau", choices: ["It is burned in factories, then ash goes to Pulau Semakau", "Into the sea", "Into outer space"], explain: "Most rubbish here is burned in special factories, and the leftover ash is taken to Pulau Semakau. It does not just vanish, so making less matters." },
