...
function buildP2cRd1() {
  ...
  return shuffle([
    ...
    { q: `${passage}\n\n小明最喜欢什么科目？`, a: "数学", choices: ["数学", "英文", "华文"], explain: "短文最后说'他最喜欢的科目是数学'，所以答案是数学。" },
...
function buildP2cRd2() {
  ...
  return shuffle([
    ...
    { q: `${passage}\n\n小美和谁一起去？`, a: "爸爸妈妈", choices: ["爸爸妈妈", "朋友", "老师"], explain: "短文里说'小美和爸爸妈妈去动物园'，和她一起去的是爸爸妈妈。" },
    ...
    { q: `${passage}\n\n小美去了哪里？`, a: "动物园", choices: ["动物园", "公园", "学校"], explain: "短文里说他们'去动物园'，所以小美去的地方是动物园。" },
  ]).map((item) => ({
    question: item.q,
    answer: item.a,
    choices: shuffle([...item.choices]),
...
function buildP2cRd3() {
  ...
  return shuffle([
    ...
    { q: `${passage}\n\n小狗叫什么名字？`, a: "小白", choices: ["小白", "小黑", "小花"], explain: "短文里说小狗'叫小白'，所以小狗的名字是小白。" },
    ...
    { q: `${passage}\n\n小华带小白去哪里？`, a: "公园", choices: ["公园", "学校", "商店"], explain: "短文里说小华带小白'去公园散步'，所以去的地方是公园。" },
  ]).map((item) => ({
    question: item.q,
    answer: item.a,
    choices: shuffle([...item.choices]),
