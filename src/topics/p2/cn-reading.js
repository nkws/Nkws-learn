...
function buildP2cRd3() {
  const passage = "小华有一只小狗，叫乐乐。乐乐的毛是白色的，很喜欢玩球。每天放学后，小华都会带乐乐去公园散步。";
  return shuffle([
    { q: `${passage}\n\n小华的宠物是什么？`, a: "小狗", choices: ["小狗", "小猫", "小鸟"], explain: "短文里说'小华有一只小狗'，所以他养的宠物是小狗。" },
    { q: `${passage}\n\n小狗叫什么名字？`, a: "乐乐", choices: ["乐乐", "小花", "多多"], explain: "问名字，就找'叫'后面的字。短文说小狗'叫乐乐'，所以名字是乐乐。" },
    { q: `${passage}\n\n乐乐的毛是什么颜色？`, a: "白色", choices: ["白色", "黑色", "棕色"], explain: "短文里说'乐乐的毛是白色的'，所以它的毛是白色。" },
    { q: `${passage}\n\n乐乐喜欢做什么？`, a: "玩球", choices: ["玩球", "睡觉", "吃东西"], explain: "短文里说乐乐'很喜欢玩球'，所以它喜欢做的事是玩球。" },
    { q: `${passage}\n\n小华什么时候带乐乐去公园？`, a: "放学后", choices: ["放学后", "早上", "中午"], explain: "短文里说'每天放学后，小华都会带乐乐去公园'，所以时间是放学后。" },
    { q: `${passage}\n\n小华带乐乐去哪里？`, a: "公园", choices: ["公园", "学校", "商店"], explain: "问'去哪里'，就找'去'后面的地方。短文说'去公园散步'，所以去的是公园。" },
  ]).map((item) => ({
    question: item.q,
    answer: item.a,
    choices: shuffle([...item.choices]),
