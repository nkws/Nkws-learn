...
function buildBd3() {
  return shuffle([
    ...
    { q: "When should you brush your teeth?", a: "Morning and night", choices: ["Morning and night", "Only at night", "Only in the morning"], explain: "Brushing washes away germs that hurt your teeth. You need to do it both morning and night — once a day is not enough." },
    { q: "When should you wash your hands?", a: "Before eating", choices: ["Before eating", "After eating", "Before going outside"], explain: "Hands pick up tiny germs throughout the day. Washing them before you eat is the most important time to stop those germs going into your tummy." },
    { q: "Which drink is the healthiest choice?", a: "Water", choices: ["Water", "Soda", "Juice"], explain: "Your body needs water to work well and stay cool. Soda and juice have added sugar, but water is pure and always the healthiest drink." },
