...
function buildP5sRp1() {
  return shuffle([
    ...
    { q: "A coconut is dispersed by?", a: "Water", choices: ["Water", "Wind", "Animals"], explain: "A coconut is light and has a tough, hollow husk that lets it float. It is carried away by water, drifting across the sea to grow on a new shore." },
