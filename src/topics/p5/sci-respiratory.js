...
function buildP5sRs1() {
  return shuffle([
    ...
    { q: "Which organ does the trachea deliver air to, so that oxygen can enter the blood?", a: "Lungs", choices: ["Lungs", "Heart", "Stomach"], explain: "Air must reach the lungs, where gas exchange occurs. The trachea is the tube that carries the air down from the nose to the lungs." },
    ...
    { q: "Which organ continuously pushes blood through blood vessels to carry oxygen to every part of the body?", a: "The heart", choices: ["The heart", "The lungs", "The stomach"], explain: "The heart is the pump of the circulatory system. It beats constantly to push blood through the blood vessels, delivering oxygen and nutrients to every part of the body." },
