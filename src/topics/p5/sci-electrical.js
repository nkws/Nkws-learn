...
function buildP5sEl1() {
  return shuffle([
    ...
    { q: "An open circuit means?", a: "There is a gap and electricity cannot flow", choices: ["There is a gap and electricity cannot flow", "Electricity flows in a loop", "The bulb is very bright"], explain: "Current needs a complete path. An open circuit has a gap, so the loop is broken and no current can flow through it — the bulb stays off." },
...
function buildP5sEl2() {
  return shuffle([
    ...
    { q: "An electric current flows from?", a: "The positive terminal of the battery through the circuit to the negative terminal", choices: ["The positive terminal of the battery through the circuit to the negative terminal", "The bulb to the battery", "The switch to the wire only"], explain: "We picture conventional current leaving the battery's positive terminal, travelling around the whole circuit, and returning to the negative terminal — a complete loop is needed for it to flow." },
