...
function buildP5mAv1() {
  return shuffle([
    ...
    { q: "Average = ?", a: "Total ÷ Number of items", choices: ["Total ÷ Number of items", "Total × Number of items", "Total + Number of items"], explain: "An average shares the whole amount equally among all the items, so you divide the total by how many there are: total ÷ number of items." },
...
function buildP5mVo1() {
  return shuffle([
    ...
    { q: "Volume of a cuboid = ?", a: "Length × Width × Height", choices: ["Length × Width × Height", "Length + Width + Height", "Length × Width"], explain: "Volume measures the space filling a 3-D shape, so you multiply all three dimensions together: length × width × height." },
