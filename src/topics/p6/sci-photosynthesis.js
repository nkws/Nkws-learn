...
function buildP6sPh1() {
  return shuffle([
    ...
    { q: "In a food chain, plants are called 'producers'. What does this label mean?", a: "They make their own food using sunlight", choices: ["They make their own food using sunlight", "They eat smaller plants for energy", "They produce carbon dioxide for animals"], explain: "In a food chain, producers are the organisms that make their own food by photosynthesis, so they need no other organism to eat. Everything else in the chain is a consumer that must eat to get energy." },
    ...
    { q: "Which ingredient of photosynthesis provides the ENERGY needed to power the reaction?", a: "Sunlight", choices: ["Sunlight", "Carbon dioxide", "Water"], explain: "Photosynthesis has three ingredients: water, carbon dioxide, and sunlight. Water and carbon dioxide are the raw materials, but sunlight is the energy source that drives the reaction and allows glucose to be made." },
