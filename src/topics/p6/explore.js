...
function buildP6ExFin1() {
  return shuffle([
    ...
    { q: "Friend A puts $500 in the bank for 1 year at 2% p.a. Friend B puts the same $500 in for 3 years. Who earns MORE simple interest?", a: "Friend B — longer time means more interest", choices: ["Friend B — longer time means more interest", "Friend A — shorter time is safer", "They earn exactly the same"], explain: "Simple interest = Principal × Rate × Time. Both have the same principal and rate, so time is what differs. $500 × 0.02 × 3 = $30 vs $500 × 0.02 × 1 = $10 — Friend B earns three times as much." },
