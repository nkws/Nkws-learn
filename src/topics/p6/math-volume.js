...
function buildP6mVo1() {
  return shuffle([
    { q: "[CUBOID:cuboid-5-4-3] A cuboid is 5 cm long, 4 cm wide and 3 cm high. What is its volume?", a: "60 cm³", choices: ["60 cm³", "12 cm³", "47 cm³"] },
    { q: "[CUBOID:cube-side-6] A cube has a side length of 6 cm. What is its volume?", a: "216 cm³", choices: ["216 cm³", "36 cm³", "18 cm³"] },
    ...
    { q: "[CUBOID:cuboid-find-height] A box has a volume of 120 cm³. If its base is 5 cm × 4 cm, what is its height?", a: "6 cm", choices: ["6 cm", "20 cm", "24 cm"] },
    ...
    { q: "[CUBOID:cube-doubled] If a cube's side is doubled, its volume becomes ___ times bigger.", a: "8", choices: ["8", "2", "4"] },
