...
function buildP6mNe1() {
  return shuffle([
    ...
    { q: "A cube net is made up of how many squares?", a: "6", choices: ["6", "4", "8"], explain: "A net is the flat shape that folds up into a solid, so it needs one piece per face. A cube has 6 faces, so its net is 6 squares." },
