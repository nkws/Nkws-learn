...
function buildP6sFd1() {
  return shuffle([
    ...
    { q: "A deer spends its days grazing on grass and leaves, eating nothing else. What type of consumer is a deer?", a: "Herbivore", choices: ["Herbivore", "Carnivore", "Omnivore"], explain: "A herbivore eats only plants. Because a deer eats only grass and leaves, it is a herbivore — the type of consumer that feeds directly on producers." },
    { q: "A wolf only hunts and eats other animals such as deer and rabbits. What type of consumer is a wolf?", a: "Carnivore", choices: ["Carnivore", "Herbivore", "Omnivore"], explain: "A carnivore eats only other animals. Because a wolf eats only other animals and no plants, it is a carnivore that sits higher in the food chain." },
    { q: "A bear eats both salmon and wild berries. What type of consumer is a bear?", a: "Omnivore", choices: ["Omnivore", "Herbivore", "Carnivore"], explain: "An omnivore eats both plants and animals. Because a bear eats both berries (plants) and fish (animals), it is an omnivore that can get energy from both levels of the food chain." },
...
function buildP6sFd2() {
  return shuffle([
    ...
    { q: "In the food chain Grass → Grasshopper → Frog, what level is the frog?", a: "Secondary consumer", choices: ["Secondary consumer", "Primary consumer", "Producer"], explain: "The grasshopper eats grass and is the primary consumer. The frog eats the grasshopper, making it the second consumer in the chain — the secondary consumer." },
    ...
    { q: "All energy in a food chain originally comes from?", a: "The Sun", choices: ["The Sun", "The producers (green plants)", "Decomposers"], explain: "Producers capture the Sun's light energy through photosynthesis. Although energy first appears in the food chain at the plants, the ultimate original source is the Sun's light that the plants convert." },
