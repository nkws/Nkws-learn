...
function buildP6sEv1() {
  return shuffle([
    ...
    { q: "Which type of adaptation describes a physical body feature — such as a bird's hollow bones or a fish's gills?", a: "Structural adaptation", choices: ["Structural adaptation", "Behavioural adaptation", "Conservation"], explain: "Structural adaptations are built-in physical features of an organism's body that help it survive. Hollow bones and gills are body parts, not actions, so they are structural adaptations." },
    { q: "A bird migrates hundreds of kilometres south each winter to find food and warmth. This is an example of:", a: "Behavioural adaptation — an action the organism takes to survive", choices: ["Behavioural adaptation — an action the organism takes to survive", "Structural adaptation — a physical body feature", "Decomposition — breaking down dead matter"], explain: "Migration is something the bird does, not a body part it was born with. Actions an organism takes to help it survive in its environment are called behavioural adaptations." },
...
function buildP6sEv2() {
  return shuffle([
    ...
    { q: "Which three actions are together known as the 3Rs of waste management?", a: "Reduce, reuse, and recycle", choices: ["Reduce, reuse, and recycle", "Remove, reject, and repair", "Replace, restore, and renew"], explain: "Reduce (use less), reuse (use again), and recycle (turn old into new) all begin with R. Together they are called the 3Rs, and each action cuts the amount of waste that ends up in the bin." },
  ]).map((item) => ({ question: item.q, answer: item.a, choices: shuffle([...item.choices]), explain: item.explain }));
}
