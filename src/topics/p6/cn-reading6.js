...
function buildP6cRd1() {
  ...
  return shuffle([
    { q: `${passage1} 小华每天几点起床？`, a: "六点半", choices: ["六点半", "七点", "六点"] },
    { q: `${passage1} 小华怎么去学校？`, a: "走路", choices: ["走路", "坐车", "骑车"] },
    { q: `${passage1} 小华最喜欢什么科目？`, a: "数学", choices: ["数学", "华文", "英文"] },
    { q: `${passage1} 小华为什么喜欢数学？`, a: "他觉得解题很有趣", choices: ["他觉得解题很有趣", "数学老师很好", "数学考试很容易"] },
    { q: `${passage1} 从家到学校要多久？`, a: "十分钟", choices: ["十分钟", "三十分钟", "一个小时"] },
    { q: `${passage2} 小美和谁去超市？`, a: "妈妈", choices: ["妈妈", "爸爸", "朋友"] },
    { q: `${passage2} 她们买了什么？`, a: "蔬菜、水果和牛奶", choices: ["蔬菜、水果和牛奶", "面包和鸡蛋", "糖果和饼干"] },
    { q: `${passage2} 小美在路上看到了谁？`, a: "一位老奶奶", choices: ["一位老奶奶", "一位老师", "一位同学"] },
    { q: `${passage2} 小美做了什么好事？`, a: "帮老奶奶提袋子", choices: ["帮老奶奶提袋子", "帮老奶奶过马路", "给老奶奶买东西"] },
    { q: `${passage2} 这个故事告诉我们什么？`, a: "要乐于助人", choices: ["要乐于助人", "要多去超市", "不要和陌生人说话"] },
