...
function buildP3WbBul1() {
  return shuffle([
    ...
    { q: "Cyberbullying is:", a: "Bullying done through phones, games, or apps", choices: ["Bullying done through phones, games, or apps", "Sending funny memes to your friends", "Spending too much time gaming"], explain: "Cyberbullying is bullying that happens online, through phones, games or apps. The mean behaviour is the same, just using a screen. Sending funny memes or gaming too long are different issues, not bullying." },
...
function buildP3WbFeel1() {
  return shuffle([
    ...
    { q: "BOX BREATHING is:", a: "In for 4, hold 4, out 4, hold 4 — repeat to calm down", choices: ["In for 4, hold 4, out 4, hold 4 — repeat to calm down", "Taking 10 quick shallow breaths as fast as you can", "Breathing in for 8 counts and out for 2"], explain: "Box breathing uses equal counts of 4: breathe in, hold, out, hold — each for 4 seconds. The slow steady rhythm tells your body to calm down. Quick breaths or uneven counts do not have the same calming effect." },
...
function buildP3WbEco1() {
  return shuffle([
    { q: "Most of Singapore's food and energy comes from:", a: "Overseas", choices: ["Overseas", "Inside Singapore only", "Underground resources in Singapore"], explain: "Singapore is small with very little farmland, so most of its food and energy is brought in from other countries overseas. That makes using them wisely important." },
