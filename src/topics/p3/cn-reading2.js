...
function buildP3cRd2() {
  ...
  return shuffle([
    ...
    { q: `${passage}\n\n公园里的花怎么了？`, a: "都开了", choices: ["都开了", "都枯了", "还没开"], explain: "把问题里的'花'当作关键词，回原文找'花'。短文说'花都开了'，照着原文回答最稳妥。" },
...
function buildP3cRd3() {
  ...
  return shuffle([
    ...
    { q: `${passage}\n\n老奶奶对小丽说了什么？`, a: "谢谢", choices: ["谢谢", "再见", "对不起"], explain: "问说了什么，就找原文里说话的句子。短文写老奶奶'笑着说谢谢'，引号般的内容就是答案。" },
